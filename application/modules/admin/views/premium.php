...
<div class="page-title">
    ...
    <span>
        ...
        <a class="btn btn-success bnt_sent_email" href="<?php echo base_url('admin/premium/premium_expire');?>">Go to Expire Featured/Premium Artist</a>
    </span>
        ...
        <div class="card">
            ...
            <div class="card-body">                
                <table class="table">
                    ...
                    <?php $i =1;foreach($worldwide_artists as $worldwide_artist){?>
