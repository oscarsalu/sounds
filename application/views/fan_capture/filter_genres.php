...
<script src="<?php echo base_url()?>assets/js/detail_pages/fancapture/filter_genre.js"></script>
...
<script src="<?php echo base_url()?>assets/js/detail_pages/fancapture/filter_genre_1.js"></script>  
<script type="text/javascript">
