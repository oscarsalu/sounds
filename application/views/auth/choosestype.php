          ...
          <div class="col-md-4 col-md-offset-4">
             <div class="panel panel-default signup-form" style=" border-color: rgba(36, 33, 33, 0.19);background-color: rgba(8, 7, 7, 0.27);color: #fff;">
                <div class="panel-body">
                   ...
                   <form id="formrole" class="form form-signup" role="form" action="<?php echo base_url().'auth/step2'?>" method="post">
                         ...
                         <div class="text-center"> <a href="<?php echo base_url().'account/signup'?>" >
                         <strong><< Edit Login Information</strong></a></div>
                </div>
             </div>
          </div>
       </div>
