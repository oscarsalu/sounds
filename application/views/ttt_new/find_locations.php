<div class="container">
    ...
    <?php} elseif ($this->session->flashdata('email_sent_err')) {
    ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <form action="" method="post" style="padding-top:10px;" id="find_location_form">
            <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />
            
        </form>
        <div class="searchform text-center">
            <button class="btn btn-info" onclick="view_location_modal_find()" style="border-radius: 7px;">Find new Location</button>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12">
        <?php echo $map['js']; ?>
...
<div id="add_detail_location_new_find" class="modal fade new_modal_style " role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form id="form_tour_submit_find" method="post">
                <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />
                <input type="hidden" name="tour_id" value="<?=$tour_id?>" class="tour_id_detail" />
                ...
                <div class="modal-body" id="form_content_data">
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-8">
                            <select name="location_country"  class="form-control" id="location_country_find">
            ...
            ?>
                ...
                <div class="modal-footer searchform">
                    ...
                    <input type="button" onclick="find_location(<?php echo $check_member['tour_id']?>)" class="btn btn-success excel-go" id="submit_form_find" value="Submit" name="submit_form_find"/>
                </div>
            </form> 
        </div>
    </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <form class="form-horizontal" id="send_email_location"  method="post">
                    <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />
                    <div class="form-group">
                    ...
                    <div class="form-group">
                  	...
                  	<div class="modal-footer">
                        ...
                        <input type="button" onclick="send_email_location(<?php echo $check_member['tour_id']?>)" class="btn btn-primary" name="sub_email" id="sub_email" value="Send mail" />
	            	  </div>
                </form>
		   	</div>			
		</div>
...
<div class="modal fade" id="bookShow">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				   <form  role="form" id="book_show_location_form" action="" method="post">
                          <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />                         
                          ...
                          <div class="row form-group">
                            ...
                            <div class="modal-footer">                           
            				    ...
            				    <button type="button" class="btn btn-primary" id="button_booking_request" onclick="book_a_show_location(<?php echo $check_member['tour_id']?>)">Send</button>
