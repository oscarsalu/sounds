...
<td>
	...
	<table width="672px">
		<tr>
			<td style="border-left:4px solid #337AB7;font-size:22px;padding-left:10px;background: #EFEFEF;color:#000;margin:10px 0">INFOMATION</td>
		</tr>
	</table>
    ...
    ?>
                    <img  src="<?php echo base_url(); ?>assets/images/default-img.gif" width="150" height="150" style="border:1px solid #DDD"/>
                <?php 
} ?>
...
<?php if ($data_json->photo == 'on') {
	...
	<table width="672px">
		<tr>
			<td style="border-left:4px solid #337AB7;font-size:22px;padding-left:10px;background: #EFEFEF;color:#000;margin:10px 0">PHOTOS</td>
		</tr>
	</table>
	...
	<table width="670px">
		<tr>
            ...
            for ($i = 1; $i <= count($photos);++$i) {
                ...
                if (!empty($photos[$i])) {
                    ?>
			<td width="220"><img src="<?php echo base_url(); ?>uploads/<?php echo $photos[$i]['user_id'] ?>/photo/<?php echo $photos[$i]['filename']; ?>" width="215" height="215" style="border:2px solid #444444;border-radius:3px;"></td>
			<?php 
                }
            } ?>
		</tr>
