							...
							<tr>
								<td align="center" valign="top">
									<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
										<tbody>
											<tr>
												<td height="20"><span style="font-size:9px;color:#f0f0f0">Updates for SafetyCulture, KanbanFlow and vCita...</span></td>
											</tr>
											<tr>
												<td align="center" height="40"><a href="<?= base_url()?>" title="99Sound" target="_blank"><img src="<?= base_url('assets/images/logo_sound99.png')?>" alt="99sound" height="50" width="116" border="0" style="border:0;border-style:none;text-decoration:none" class="CToWUd"></a></td>
											</tr>
											<tr>
														...
														<tbody>
															<tr>
																<td align="center" style="font-family:&quot;Open Sans&quot;,Helvetica,Arial,sans-serif">
																	<h1 style="color:#333;display:block;font-family:&quot;Open Sans&quot;,Helvetica,Arial,sans-serif;font-size:25px;font-weight:bold;line-height:130%;margin:0 0 15px;padding:0">Forgot Passwod 99Sound</h1>
																	<p style="line-height:170%;margin:15px 0;padding:0">This email has been sent as a request to reset our password.</p>
																</td>
															</tr>
															<tr>
																					...
																					<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;display:inline-block">
																						<tbody>
																							<tr>
                                                                                                ...
                                                                                                <a href="<?=base_url('auth/reset_password/'.$encrypted_string.'/'.$user_id)?>" style="color:#fff;font-family:&quot;Open Sans&quot;,&quot;HelveticaNeue-Light&quot;,&quot;Helvetica Neue Light&quot;,&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-size:16px;font-weight:300;line-height:180%;text-decoration:none" target="_blank">Go to Reset Password!</a></td>
																							</tr>
																						</tbody>
																					</table>
																				</td>
