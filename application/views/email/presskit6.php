...
<td>
	...
	<table width="670px" style="background: #EFEFEF;border-top:1px solid #CBD0D6;padding:20px 0">
		<tr style="">
			<td style="font-size:28px;padding-left:10px;color:#595959;" align="center">INFOMATION</td>
		</tr>
	</table>

	<table width="670" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#EFEFEF" style="border-bottom:1px solid #CBD0D6">
		<tr>
    ...
    ?>
		                    <img  src="<?php echo base_url(); ?>assets/images/default-img.gif" width="150" height="150" style="border:1px solid #DDD;border-radius:50%"/>
		                <?php 
} ?>
    ...
    ?>
								<tr>
									...
									<td width="150" >
										<div style="background: #DDD; height: 17px;border-radius:9px">
											<div style="background: rgba(22, 122, 198, 0.73); height: 17px;border-radius:9px;width:<?php echo $this->Member_model->stast_fan($fans, 13, 17)?>%"></div>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td width="150" >
										<div style="background: #DDD; height: 17px;border-radius:9px">
											<div style="background: rgba(22, 122, 198, 0.73); height: 17px;border-radius:9px;width:<?php echo $this->Member_model->stast_fan($fans, 18, 24)?>%"></div>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td width="150" >
										<div style="background: #DDD; height: 17px;border-radius:9px">
											<div style="background: rgba(22, 122, 198, 0.73); height: 17px;border-radius:9px;width:<?php echo $this->Member_model->stast_fan($fans, 25, 34)?>%"></div>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td width="150" >
										<div style="background: #DDD; height: 17px;border-radius:9px">
											<div style="background: rgba(22, 122, 198, 0.73); height: 17px;border-radius:9px;width:<?php echo $this->Member_model->stast_fan($fans, 35, 44)?>%"></div>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td width="150" >
										<div style="background: #DDD; height: 17px;border-radius:9px">
											<div style="background: rgba(22, 122, 198, 0.73); height: 17px;border-radius:9px;width:<?php echo $this->Member_model->stast_fan($fans, 45, 200)?>%"></div>
										</div>
									</td>
								</tr>
								<?php 
...
<?php if ($data_json->photo == 'on') {
    ?>
	<!--PHOTOS-->
	<table width="670px" style="background: #E8E8E8;padding:20px ">
		<tr>
			<td style="font-size:28px;padding-left:10px;background: #E8E8E8;color:#888889;margin:10px 0" align="center">PHOTOS</td>
		</tr>
	</table>

	<table width="670px" style="background: #E8E8E8;border-bottom:1px solid #CBD0D6;padding-bottom:10px;">
		<tr>
			<?php
            for ($i = 1; $i <= count($photos);++$i) {
                ...
                if (!empty($photos[$i])) {
                    ?>
			<td width="220"><img src="<?php echo base_url(); ?>uploads/<?php echo $photos[$i]['user_id'] ?>/photo/<?php echo $photos[$i]['filename']; ?>" width="212" height="212" style="border:2px solid #444444;border-radius:3px;"></td>
			<?php 
                }
            } ?>
		</tr>
...
<?php 
	...
	<table width="670px" style="background: #EFEFEF;padding:20px 0;">
		<tr>
			<td style="font-size:28px;color:#595959;margin:10px 0" align="center">STATS</td>
		</tr>
	</table>

	<table width="670px" style="background: #EFEFEF;font-size:18px">
		<tr>
...
<?php 
    ...
    ?>
	<!--VIDEOS-->
	<table width="670" style="background:#E8E8E8;padding:20px 0;border-top:1px solid #CBD0D6">
		<tr>
			<td style="font-size:28px;padding-left:10px;color:#888889;margin:10px 0" align="center">VIDEOS</td>
		</tr>
	</table>

<table width="670px" border="0" cellspacing="0" cellpadding="0" style="background:#E8E8E8;">
    <tr>
	...
	<table width="670" style="padding:15px 0;background:#E8E8E8;border-bottom:1px solid #CBD0D6">
		<tr align="center">
...
<?php 
	...
	<!--SONG-->
	<table width="670px" style="background: #E8E8E8;padding:20px 0;border-top:1px solid #CBD0D6">
		<tr>
			<td style="font-size:28px;color:#888889;;" align="center">SONG</td>
		</tr>
	</table>

	<table width="670px" style="background: #E8E8E8;padding-bottom:10px;border-bottom:1px solid #CBD0D6">
		<tr>
			<td width="400">
 ...
 <?php if ($data_json->press == 'on') {
    ?>
	<!--PRESS-->
	<table width="672px" style="background: #EFEFEF;padding:20px 0">
		<tr>
...
<?php 
	...
	<table width="670px" style="background: #E8E8E8;padding-bottom:15px;border-bottom:1px solid #CBD0D6">
		<tr>
			<td>
				<table>
					<tr>
...
<?php 
	...
	<!--FOOTER-->
	<table width="670" align="center" style="background: #EFEFEF">
		<tr>
			<td width="330">
				<table>
					<tr width="330">
