...
<td>
	...
	<table width="670px" style="background: #F8F8F8;border-top:1px solid #CBD0D6;padding:20px 0">
		<tr >
			<td style="font-size:28px;color:#337AB7;" align="center">INFOMATION</td>
		</tr>
	</table>
...
<table width="670px" style="background: #F8F8F8;padding:20px 0">
    ...
    ?>
							<table align="center">
								<tr>
									<td width="70" align="center">13-17</td>
									<td width="220" >
								...
								<tr>
									<td width="70" align="center">18-24</td>
									<td width="220" >
										<div style="background: #CCC; height: 20px;">
								...
								<tr>
									<td width="70" align="center">25-34</td>
									<td width="220" >
										<div style="background: #CCC; height: 20px;">
								...
								<tr>
									<td width="70" align="center">35-44</td>
									<td width="220" >
										<div style="background: #CCC; height: 20px;">
											<div style="background: #337AB7; height: 20px;width:<?php echo $this->Member_model->stast_fan($fans, 35, 44)?>%"></div>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td width="220" >
										<div style="background: #CCC; height: 20px;">
											<div style="background: #337AB7; height: 20px;width:<?php echo $this->Member_model->stast_fan($fans, 45, 200)?>%"></div>
										</div>
									</td>
								</tr>
							</table>
...
<?php if ($data_json->photo == 'on') {
    ?>
	<!--PHOTOS-->
	<table width="670px" style="background: #F4F4F4;padding:20px;border-top:1px solid #CBD0D6; ">
		<tr>
			<td style="font-size:28px;color:#337AB7;" align="center">PHOTOS</td>
		</tr>
	</table>
    ...
    ?>
					<tr>
						<td colspan="3">
						<a href="<?php echo base_url(); ?>uploads/<?php echo $photos[0]['user_id']; ?>/photo/<?php echo $photos[0]['filename']; ?>" width="355" height="250">
                            <img src="<?php echo base_url(); ?>uploads/<?php echo $photos[0]['user_id']; ?>/photo/<?php echo $photos[0]['filename']; ?>" width="355" height="250">
                        </a>
                        </td>
						<!--
						<td colspan="3"><img src="avatar.png" width="355" height="250"></td>
						-->
					</tr>
					<?php
                    for ($i = 1; $i <= count($photos);++$i) {
                        ...
                        if (!empty($photos[$i])) {
                            ?>
							<td width="120"><img src="<?php echo base_url(); ?>uploads/<?php echo $photos[$i]['user_id'] ?>/photo/<?php echo $photos[$i]['filename']; ?>" width="115" height="115"></td>
					<?php 
                        }
                    }
} ?>
			...
			<td width="310">
				<table width="300">
					<tr>
						<td>
							<h2>Onions <b style="background:#5CB85C;padding:10px;border-radius:5px;">Available</b></h2>
	...
	<table width="670px" style="background: #F8F8F8;padding:20px 0;">
		<tr>
			<td style="font-size:28px;color:#337AB7;" align="center">STATS</td>
		</tr>
	</table>
			...
			<td>
				<table  style="border-collapse: collapse;border-radius:5px 5px 0 0;line-height:30px">
					...
					<tr  align="center"  style="border-bottom:1px solid #D0D0D0">
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 13, 17, 1)?>%;height: 20px;"></div>
							</div>
						</td>
						<td >13-17</td>
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 13, 17, 2)?>%;height: 20px;"></div>
							</div>
						</td>
					</tr>
					...
					<tr align="center" style="background:#EFEFEF;border-bottom:1px solid #D0D0D0">
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 18, 24, 1)?>%;height: 20px;"></div>
							</div>
						</td>
						<td>18-24</td>
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 18, 24, 2)?>%;height: 20px;"></div>
							</div>
						</td>
					</tr>
					<tr align="center" style="border-bottom:1px solid #D0D0D0">
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 25, 34, 1)?>%;height: 20px;"></div>
							</div>
						</td>
						<td>25-34</td>
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 25, 34, 2)?>%;height: 20px;"></div>
							</div>
						</td>
					</tr>
					<tr align="center" style="background:#EFEFEF;border-bottom:1px solid #D0D0D0">
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 35, 44, 1)?>%;height: 20px;"></div>
							</div>
						</td>
						<td>35-44</td>
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 35, 44, 2)?>%;height: 20px;"></div>
							</div>
						</td>
					</tr>
					<tr align="center" style="border-bottom:1px solid #D0D0D0">
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 45, 54, 1)?>%;height: 20px;"></div>
							</div>
						</td>
						<td>45-54</td>
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 45, 54, 2)?>%;height: 20px;"></div>
							</div>
						</td>
					</tr>
					<tr align="center" style="background:#EFEFEF;border-bottom:1px solid #D0D0D0">
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 55, 200, 1)?>%;height: 20px;"></div>
							</div>
						</td>
						<td>55+</td>
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 55, 200, 2)?>%;height: 20px;"></div>
							</div>
						</td>
					</tr>
					<tr align="center" style="border-bottom:1px solid #D0D0D0">
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 0, 12, 1)?>%;height: 20px;"></div>
							</div>
						</td>
						<td>n/a</td>
						<td>
							<div style="height: 20px;background-color:#CCC">
								<div style="background:#337AB7;width:<?php echo $this->Member_model->stast_fan($fans, 0, 12, 2)?>%;height: 20px;"></div>
							</div>
						</td>
					</tr>
			</table>
	...
	<table width="670" style="background:#F4F4F4;padding:20px 0;border-top:1px solid #CBD0D6">
		<tr>
			<td style="font-size:28px;padding-left:10px;color:#337AB7;margin:10px 0" align="center">VIDEOS</td>
		</tr>
	</table>
...
<table width="670px" border="0" cellspacing="0" cellpadding="0" style="background:#F4F4F4;">
	...
	<!--BIOS-->
	<table width="670px" style="background: #EFEFEF;padding:20px 0;">
		<tr>
			<td style="font-size:28px;color:#337AB7;" align="center">BIOS</td>
		</tr>
	</table>

	<table width="670px" style="background: #EFEFEF;padding-bottom:15px;">
		<tr>
			<td width="190">
				<?php if ($photo != 'notfound') {
    ?>
                    <img width="170" height="170" src="<?php echo base_url(); ?>uploads/<?php echo $photo['user_id']; ?>/photo/avatar.png ?>" />    
                <?php 
} else {
    ?>
	...
	<table width="670px" style="background: #F4F4F4;padding:20px 0;border-top:1px solid #CBD0D6">
		<tr>
			<td style="font-size:28px;color:#337AB7;;" align="center">SONG</td>
		</tr>
	</table>
	...
	<!--END SONG-->
<?php if ($data_json->press == 'on') {
    ?>
	<!--PRESS-->
	<table width="672px" style="background: #F8F8F8;padding:20px 0">
		<tr>
			<td style="font-size:28px;color:#337AB7" align="center">PRESS</td>
		</tr>
	</table>
...
<?php 
	...
	<table width="670px" style="background: #F4F4F4;padding:20px 0;border-top:1px solid #CBD0D6">
		<tr>
			<td style="font-size:28px;color:#337AB7" align="center">SHOWS</td>
		</tr>
	</table>
