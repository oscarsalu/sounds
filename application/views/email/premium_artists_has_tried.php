														...
														<tbody>
															<tr>
																<td align="center" style="font-family:&quot;Open Sans&quot;,Helvetica,Arial,sans-serif">
																	...
																	<p style="line-height:170%;margin:15px 0;padding:0">This email invite a request to Our Featured / Premium Artists has Expires.</p>
																</td>
															</tr>
															<tr>
                                                            ...
                                                            <tr>
																<td style="font-family:&quot;Open Sans&quot;,Helvetica,Arial,sans-serif">
                                                                    ...
                                                                    <p>You had bought package Featured / Premium Artists in <?php if ($user['pack'] == 1) {
    echo $pack['pack'].' week';
} else {
    echo $user['pack'].'weeks';
}?> has expires </p>
                                                                    <p><?php echo 'Start date: '.date('H:i:s m/d/Y', strtotime($user['start_day']));?></p>
                                                                    <p><?php echo 'Expires date: '.date('H:i:s m/d/Y', strtotime($user['end_day']));?></p>
															     </td>
                                                            </tr>	
															<tr>
																<td align="center" style="font-family:&quot;Open Sans&quot;,Helvetica,Arial,sans-serif">
