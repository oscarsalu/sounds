...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url()?>/assets/epk/template2/epk2.css">
...
<div class="">
    ...
    ?>
    <h1 class="text-center"><?php echo ucfirst($res_data_artist['artist_name'])?></h1>
    <?php 
    ...
    ?>
                        <div id="info_statistics_div_placeholder" style="">
                            <div style="text-align: right;padding-right: 10px;"><a href="#" class="send_to" tab="artist_tab_detailed_stats">See detailed fan stats »</a></div>
                            <ul class="new_charts">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="side">
                            <div style="float:left">
                                ...
                                <?php custom_echo_html($res_data_artist['bio'], 300)?>
                                <p></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="photos_wrapper">
                        <div style="text-align: center; width: 100%;"> 
                            ...
                            foreach ($photos as $pt) {
                                ?><img width="150" class="img-responsive photo_image" src="<?php echo base_url(); ?>uploads/<?php echo $pt['user_id']; ?>/photo/<?php echo $pt['filename']; ?>" /><?php
    ...
    ?><a href="www.googo.com" target="_blank"><?php
...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalPhoto" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form form-signup" id="update_pt" role="form"  method="post">
			    <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" /> 
            	<div class="modal-body">
                    <div class="form-group">
						...
						<div class="input-group col-md-8">
                            ...
                            <input type="checkbox"  name="to[public_email]" value="<?php if(!empty($customize['email_artist'])) { echo $customize['email_artist']; }else {'';} ?>" <?php if (empty($customize['email_artist'])) {
    echo 'disabled';
} else {
    echo 'checked';
} ?>/>Artist</label>
							<label  class="checkbox"><input type="checkbox"  name="to[booking_email]" value="<?php if(!empty($customize['email_booking'])) { echo $customize['email_booking']; }else{'';} ?>" <?php if (empty($customize['email_booking'])) {
    echo 'disabled';
} else {
    echo 'checked';
} ?>/>Booking</label>
						    <label  class="checkbox"><input type="checkbox"  name="to[mngt_email]" value="<?php if(!empty($customize['email_manager'])) { echo $customize['email_manager']; }else{'';} ?>"<?php if (empty($customize['email_manager'])) {
    echo 'disabled';
} else {
    echo 'checked';
} ?>/>Management</label>
