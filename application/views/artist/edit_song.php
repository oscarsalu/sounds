				...
				<section class="tile" style="padding: 0px;">
                    ...
                    <div id="rootwizard" class="tab-container tab-wizard">
                        <ul class="nav nav-tabs nav-justified">
                            ...
                            <li id="agreement"><a href="#tab5" data-toggle="tab"><span style="visibility:hidden;">Test1</span>User Agreement<span class="badge badge-default pull-right wizard-step">5</span></a></li>
                        </ul>
...
<div class="alert alert-danger  avail-popup" role="alert" style="display:none;">
                               ...
                               <form name="step1" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                						...
                						<div class="col-md-6 col-xs-9 input-group">
                							...
                							<input type="text" size="10" name="song_name" id="song_name" value="<?=$data_song->song_name?>" class="form-control"  data-parsley-required data-parsley-songname>
                					...
                					<div class="form-group" >
                						...
                						<div class="col-md-6 col-xs-9 input-group">
                						     <select class="chosen-select form-control "   data-parsley-required  id="availability" data-placeholder="Choose availability..." name="availability" onchange="return do_disable();" >
                                                                         <option value="">Choose Availability</option>
                								<?php $array_avai = $data_song->availability; ?>
                                                <!--<option value="1"<?php if (in_array('1', $array_avai)) {
    echo 'selected';
}?>>Artist Music Player</option>
                								<!--<option value="2"<?php if (in_array('2', $array_avai)) {
    echo 'selected';
}?>>Download Only</option>
                								<option value="3"<?php if (in_array('3', $array_avai)) {
    echo 'selected';
}?>>Electronic Press Kit</option>-->
                								 <?php if($attribute=="1"){ ?>	<option value="4"<?php if ($array_avai=="4") {
    echo 'selected';
                                                                                 }?> > AMP/ALP Streaming</option><?php } ?>
                								<!--<option value="5"<?php if (in_array('5', $array_avai)) {
    echo 'selected';
}?>>99Sound Streaming</option>-->
                					 		<option value="6"<?php if ($array_avai=="6") {
    echo 'selected';
}?>>Hidden</option> 
                							</select><br />
                						</div>
                                    ...
                                    <div class="form-group" >
                						<label class="col-xs-3 control-label">Price/Song</label>
                                            <div class=" col-md-6 col-xs-9 input-group">
                                                <input type="number" class="form-control" name="price" id="price" value="<?=$data_song->price?>" min="0.00" pattern="[0-9]+([\.,][0-9]+)?" step="0.01"
                                            ...
                                            <select class="form-control" name="currency" id="currency" onchange="return currencyConverter();">
                                                <option value="USD" <?php if($data_song->currency=="USD"){ echo "selected";} ?>>  US Dollar </option>
                                                <option value="CAD" <?php if($data_song->currency=="CAD"){ echo "selected";} ?>>Canadian Dollar</option>  
                                                 <option value="EUR" <?php if($data_song->currency=="EUR"){ echo "selected";} ?>>Euro</option>   
                                               </select>
  ...
  <p><b>Supported Audio Formats are not compatible across all Browsers listed below.
                                Please Upload the correct type <br>you wish to play your song.
                                Multiple formats for ONE SONG may be loaded.Note:Almost all Browsers play MP3,MP4</b></p>
                                <div class="col-md-6">
       ...
       Firefox
                                   ...
                                   <div class="invalid-form-error-message"></div>
                                    ...
                                    <tr>
                						<td>Audio File .WEBMA, .WEBM
                                                                    ...
                                                                    <input type="file" class="form-control" id="file_audio1"  name="file_audio1" accept="audio/webm"  />
                						 <?php if($data_song->audio_file1){
                                        ?>
                                    
                                        <h4><strong><?=$data_song->audio_file1?></strong></h4>
                                      
                                        <input type="hidden" id="audio_path1" value="<?=$data_song->audio_file1?>" />
                                ...
                                Audio File .OGA,.OGG
                							...
                							<input type="file" class="form-control"  id="file_audio2"  name="file_audio2" accept="audio/oga" />
                						<?php if($data_song->audio_file2){ ?>
                                    
                                        <h4><strong><?=$data_song->audio_file2?></strong></h4>
                					...
                					Audio File M4A,MP4
                							...
                							<input type="file" class="form-control" id="file_audio3" name="file_audio3" accept="audio/mp4"   />
                                                                        
                						                                 <?php if($data_song->audio_file3){ ?>
                                    
                                        <h4><strong><?=$data_song->audio_file3?></strong></h4>
                                       
                                        <input type="hidden" id="audio_path3" value="<?=$data_song->audio_file3?>" />
                                   ...
                                   Audio File .MP3
                							...
                							<input type="file" class="form-control" id="file_audio4" name="file_audio4" accept="audio/mpeg"  />
                						                               <?php if($data_song->audio_file4){ ?>
                                 
                                        <h4><strong><?=$data_song->audio_file4?></strong></h4>
                                      
                                        <input type="hidden" id="audio_path4" value="<?=$data_song->audio_file4?>" />
                                ...
                                <tr><td>
                						Audio File  <br>(format:WAV)</label>
                						...
                						<?php if($data_song->audio_file5){ ?>
                                   
                                        <h4><strong><?=$data_song->audio_file5?></strong></h4>
                                       
            							
                                        <input type="hidden" id="audio_path5" value="<?=$data_song->audio_file5?>" />
                                    ...
                                    <a href="#" class="btn btn-xs btn-danger remove_upload_new" style="display: none;" > Remove upload new</a>
                               ...
                               <div class="form-group" >
                						...
                						<div class="col-md-6 col-xs-9 input-group">
                							<input type="file" class="form-control" accept="video/*" name="file_video1" required data-parsley-errors-messages-disabled/>
                                                                         <?php
                                    if (!empty($data_song->video_file1)) {
                                        ?>
                                       
                                            <h4><strong><?=$data_song->video_file1?></strong></h4>
                                            <input type="hidden" id="video_path1" value="<?=$data_song->video_file1?>" />
                                    ...
                                    ?>
                                     ...
                                     <div class="form-group" >
                						...
                						<div class="col-md-6 col-xs-9 input-group">
                						 ...
                						 <?php
                                    if (!empty($data_song->video_file2)) {
                                        ?>
                                       
                                            <h4><strong><?=$data_song->video_file2?></strong></h4>
                                            <input type="hidden" id="video_path2" value="<?=$data_song->video_file2 ?>" />
                                    ...
                                    <div class="form-group" >
                						...
                						<div class="col-md-6 col-xs-9 input-group">
                						 ...
                						 <?php
                                    if (!empty($data_song->video_file3)) {
                                        ?>
                                       
                                            <h4><strong><?=$data_song->video_file3 ?></strong></h4>
                                            <input type="hidden" id="video_path3" value="<?=$data_song->video_file3?>" />
                                            
                                        <?php 
                                    }
                                    ?>
                                            <input type="hidden" id="song_id" name="song_id" value="<?php if(isset($song_id) && !empty($song_id)){ echo $song_id ;} ?>"  >                        
                                                                </div>
                					</div>
                            ...
                            <div class="tab-pane" id="tab4">
                                <form class="form-horizontal" name="step4" role="form" novalidate>
                                    <div class="form-group" >
                                        ...
                                        <div class="input-group col-xs-8">
                                            <label class="radio-inline">
                                                <input type="radio" name="options_demo" <?php if($data_song->option_type=="1"){ echo 'checked=""'; }?> id="radio_audio" value="1"> Audio
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="options_demo" id="radio_video" value="2" <?php if($data_song->option_type=="2"){ echo 'checked=""'; }?>> Video
                                            </label>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="form-group" id="box_demo_audio" >
                                        ...
                                        <div class="input-group col-xs-8">
                                            <input id="duration_audio" name="duration_play_audio" type="text" class="form-control " value="" data-slider-handle="triangle" data-slider-max="1000" data-slider-step="1" data-slider-value="[<?=$data_song->time_start?>,<?=$data_song->time_duration + $data_song->time_start?>]"/>
                                        </div>
                                    </div>
                                    <div class="form-group" id="box_demo_video" style="display: none;">
                                        ...
                                        <div class="input-group col-xs-8 ">
                                            <input id="duration_video" name="duration_play_video" type="text" class="form-control " value="" data-slider-handle="triangle" data-slider-max="1000" data-slider-step="1" data-slider-value="[<?=$data_song->time_start?>,<?=$data_song->time_duration + $data_song->time_start?>]"/>
                                        </div>
                                    </div><br />
                                    ...
                                    <div class="checkbox">
                                        <label class="checkbox checkbox-custom">
                                            <input type="checkbox" name="agree" id="agree"
                                                   required><i></i> I agree to the <a target="_blank" href="<?=base_url('footer/terms')?>" class="text-info">Terms of Service</a>
                                        </label>
                                    </div>
                                </form>
        ...
        window.ParsleyValidator
                .addValidator('songname', function (value, requirement) {
                    ...
                    $.ajax({
                        ...
                        data: {song_name: value,csrf_test_name:get_csrf_hash, song_id:song_id},
                        dataType: 'json',
                        type: 'post',
                        async: false,
