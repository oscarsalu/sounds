    ...
    $.ajax({
        ...
        data: 
        {
            'csrf_test_name':get_csrf_hash,
             ...
             des: $('#form_tour_des_submit').find("#event_desc_tour").val(),
        },
        success: function(data){
            if(data['status']){
                alertify.success(data['msg']);
                $('#uploadvideo').modal('hide');
                $(".show_des").html($('#form_tour_des_submit').find("#event_desc_tour").val());
            }else{
                alertify.error(data['msg']); 
            }
        },
...
function view_location_modal(type,fn_name){
...
$.ajax({
    ...
    success: function(data){
      ...
      if(data['status']){
        ...
        $(".linkmenumember").attr('href',base_url+'the_total_tour/members/'+tour)
        $(".linkcaculate").attr('href',base_url+'the_total_tour/caculate/'+tour)
        $(".linkevent").attr('href',base_url+'the_total_tour/event/'+tour)
        $(".linkschedules").attr('href',base_url+'the_total_tour/schedules/'+tour)
        ...
        if(data['tour_data']['des']){
            $("#collapseOne .show_des").html(data['tour_data']['des']);
            $("#collapseOne .tour_des").val("Edit");
            $("#collapseOne .tour_des").html("Edit");
        }else{
            $("#collapseOne .show_des").html('');
            $("#collapseOne .tour_des").val("Add");
            $("#collapseOne .tour_des").html("Add");
        }
