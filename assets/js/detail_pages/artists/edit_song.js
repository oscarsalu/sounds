    ...
    $('#rootwizard').bootstrapWizard({
      ...
      $("input[name=file_video1]").removeAttr('required').parsley().destroy();
        ...
        $("input[name=file_audio4]").attr('required', 'required').parsley();
            $("input[name=file_audio5]").attr('required', 'required').parsley();
...
$('.invalid-form-error-message').html('<div class="alert alert-danger">You must upload any one audio or video </div>');
    ...
    function check_duration() {
           if( $("#audio_path1").val()!=null)
           {
        var audio_path = $("#audio_path1").val();
           }
           else if( $("#audio_path1").val()!=null)
           { 
           var audio_path = $("#audio_path2").val();
        }
        else if( $("#audio_path2").val()!=null)
           { 
           var audio_path = $("#audio_path2").val();
        }
        else if( $("#audio_path3").val()!=null)
           { 
           var audio_path = $("#audio_path3").val();
        }
        else if( $("#audio_path4").val()!=null)
           { 
           var audio_path = $("#audio_path4").val();
        }
        else if( $("#audio_path5").val()!=null)
           { 
           var audio_path = $("#audio_path5").val();
        }
        else if( $("#audio_path6").val()!=null)
           { 
           var audio_path = $("#audio_path6").val();
        }
        
        if( $("#video_path1").val()!=null) {
        var video_path = $("#video_path1").val();
    } 
    else if ($("#video_path1").val()!=null)
    {
         var video_path = $("#video_path2").val();
        
    }
    else if ($("#video_path2").val()!=null)
    {
         var video_path = $("#video_path2").val();
        
    }
    else if ($("#video_path3").val()!=null)
    {
         var video_path = $("#video_path3").val();
...
$(document).ready(function(){
    ...
    $('#finish').click(function(e){
       ...
       if( $("#audio_path1").val()!=null)
           {
        var audio_path1 = $("#audio_path1").val();
           }
           else {
              var audio_path1 = ""; 
           }
           
         if( $("#audio_path2").val()!=null)
           { 
           var audio_path2 = $("#audio_path2").val();
        }
        else {
            var audio_path2 = "";
        }
         if( $("#audio_path3").val()!=null)
           { 
           var audio_path3 = $("#audio_path3").val();
        }
        else {
             var audio_path3 = "";
        }
         if( $("#audio_path4").val()!=null)
           { 
           var audio_path4 = $("#audio_path4").val();
        }
        else {
            var audio_path4 = "";
        }
         if( $("#audio_path5").val()!=null)
           { 
           var audio_path5 = $("#audio_path5").val();
        }
        else {
            var audio_path5 ="";
        }
         if( $("#audio_path6").val()!=null)
           { 
           var audio_path6 = $("#audio_path6").val();
        }
        else {
             var audio_path6 = "";
        }
        ...
        if( $("#video_path1").val()!=null) {
        var video_path1 = $("#video_path1").val();
    } 
      else {
               var video_path1= "";
        }
     if ($("#video_path2").val()!=null)
    {
         var video_path2 = $("#video_path2").val();
        
    }
    else {
              var video_path2 = "";
        }
     if ($("#video_path3").val()!=null)
    {
         var video_path3 = $("#video_path3").val();
       ...
       $.ajax({ 
             ...
             data: {
                ...
                'audio_path1':  audio_path1,
                'video_path1':  video_path1, 
                'audio_path2':  audio_path2,
                'video_path2':  video_path2, 
                'audio_path3':  audio_path3,
                'video_path3':  video_path3,
                
                'audio_path4':  audio_path4,
              
                'audio_path5':  audio_path5,
                
                'audio_path6':  audio_path6
