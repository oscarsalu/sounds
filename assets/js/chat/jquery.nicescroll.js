...
(function(f) {
    var l = false,
        ...
        m = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || false,
        n = window.cancelRequestAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame ||
        ...
        x = function(e, d) {
            ...
            this.nativescrollingarea = this.locked = false;
            this.events = [];
            this.saved = {};
            this.delaylist = {};
            var i = document.createElement("DIV");
            this.isopera = "opera" in window;
            this.isieold = (this.isie = "all" in document && "attachEvent" in i && !this.isopera) && !("msInterpolationMode" in i.style);
            this.isie7 = this.isie && !this.isieold && (!("documentMode" in document) || document.documentMode == 7);
            this.isie8 = this.isie &&
                "documentMode" in document && document.documentMode == 8;
            this.isie9 = this.isie && "performance" in window && document.documentMode >= 9;
            this.ismozilla = "MozAppearance" in i.style;
            this.ischrome = "chrome" in window;
            this.isios4 = (this.isios = (this.cantouch = "ontouchstart" in document.documentElement) && /iphone|ipad|ipod/i.test(navigator.platform)) && !("seal" in Object);
            if (b.opt.hwacceleration) {
                if ((this.trstyle = window.opera ? "OTransform" : document.all ? "msTransform" : i.style.webkitTransform !== void 0 ? "webkitTransform" : i.style.MozTransform !==
                        void 0 ? "MozTransform" : false) && typeof i.style[this.trstyle] == "undefined") this.trstyle = false;
                if (this.hastransform = this.trstyle != false) i.style[this.trstyle] = "translate3d(1px,2px,3px)", this.hastranslate3d = /translate3d/.test(i.style[this.trstyle]);
                this.transitionstyle = false;
                this.prefixstyle = "";
                this.transitionend = false;
                var p = "transition,webkitTransition,MozTransition,OTransition,msTransition,KhtmlTransition".split(","),
                    k = ",-webkit-,-moz-,-o-,-ms-,-khtml-".split(","),
                    u = "transitionEnd,webkitTransitionEnd,transitionend,oTransitionEnd,msTransitionEnd,KhtmlTransitionEnd".split(",");
                for (h = 0; h < p.length; h++)
                    if (p[h] in i.style) {
                        this.transitionstyle = p[h];
                        this.prefixstyle = k[h];
                        this.transitionend = u[h];
                        break
                    }
            ...
            this.delayed = function(c, g, d) {
                var j = b.delaylist[c],
                    e = (new Date).getTime();
                if (j && j.tt) return false;
                if (j && j.last + d > e && !j.tt) b.delaylist[c] = {
                    last: e + d,
            ...
            BezierClass = function(b, g, d, j, e, v, f) {
                this.st = b;
                this.ed = g;
                this.spd = d;
                this.p1 = j || 0;
            ...
            BezierClass.prototype = {
                ...
                getNow: function() {
                    var b = 1 - ((new Date).getTime() - this.ts) / this.spd,
                        g = this.B2(b) +
                        this.B3(b) + this.B4(b);
                    return b < 0 ? this.ed : this.st + Math.round(this.df * g)
                },
                update: function(b, g) {
                    this.st = this.getNow();
                    this.ed = b;
            ...
            this.ishwscroll ? (this.doc.translate = {
                ...
                g.initUIEvent("scroll", false, true, window, 1);
                b.dispatchEvent(g)
            } : document.fireEvent ? function(b) {
                var g = document.createEventObject();
                b.fireEvent("onscroll");
                g.cancelBubble = true
            } : function() {}, this.setScrollTop = this.hastranslate3d ? function(c, g) {
            ...
            this.hasParent = function(b, g) {
                if (!b) return false;
                for (var d = b.target || b.srcElement || b || false; d && d.id != g;) d = d.parentNode || false;
                return d !== false
            };
            this.updateScrollBar = function(c) {
                if (b.ishwscroll) b.rail.css({
                    ...
                    var g = b.win.offset();
                    g.top += 2;
                    var d = (b.win.outerWidth() - b.win.innerWidth()) / 2;
                    g.left += b.win.innerWidth() + d -
                        b.rail.width - 1;
                    if (d = b.opt.railoffset) d.top && (g.top += d.top), d.left && (g.left += d.left);
                    b.rail.css({
                        top: g.top,
                        left: g.left,
            ...
            b.hasanimationframe = m;
            b.hascancelanimationframe = n;
            b.hasanimationframe ? b.hascancelanimationframe || (n = function() {
            ...
            this.init = function() {
                b.saved.css = [];
                if (!b.ispage || !b.cantouch && !b.isieold) {
                    var c = b.docscroll;
                    b.ispage &&
                        (c = b.haswrapper ? b.win : b.doc);
                    b.css(c, {
                        "overflow-y": "hidden"
                    });
                    b.ispage && b.isie7 && b.win[0].nodeName == "BODY" && b.css(f("html"), {
                        "overflow-y": "hidden"
                    });
                    ...
                    c.attr("id", b.id);
                    c.width = 1 + Math.max(parseFloat(b.opt.cursorwidth), d.outerWidth());
                    c.css({
                        "padding-left": "0px",
                        "padding-right": "1px",
                        width: c.width + "px",
                    ...
                    b.rail = c;
                    d = b.rail.drag = false;
                    if (b.opt.boxzoom && !b.ispage && !b.isieold && (d = document.createElement("div"), b.bind(d, "click", b.doZoom), b.zoom = f(d), b.zoom.css({
                            cursor: "pointer",
                            "z-index": b.opt.zindex,
                            backgroundImage: "url(" + t + "zoomico.png)",
                            height: 18,
                            width: 18,
                    ...
                    if (b.opt.autohidemode === false) b.autohidedom = false;
                        ...
                        true) b.autohidedom = b.rail;
                    else if (b.opt.autohidemode == "cursor") b.autohidedom = b.cursor;
                    b.cantouch || b.opt.touchbehavior ? (b.scrollmom = {
                        y: new w(b)
                    }, b.onmousedown = function(c) {
                        if (!b.locked && (b.cancelScroll(), b.rail.drag = {
                                x: c.screenX,
                                y: c.screenY,
                                sx: b.scroll.x,
                                sy: b.scroll.y,
                                st: b.getScrollTop()
                            }, b.hasmoving = false, b.lastmouseup = false, b.scrollmom.y.reset(c.screenY), !b.cantouch)) return b.cancelEvent(c)
                    }, b.onmouseup = function(c) {
                        if (b.rail.drag && (b.scrollmom.y.doMomentum(), b.rail.drag = false, b.hasmoving && (b.hasmoving =
                                false, b.lastmouseup = true, b.hideCursor(), !b.cantouch))) return b.cancelEvent(c)
                    }, b.onclick = b.isios ? false : function(c) {
                        ...
                        cursor: b.cursorgrabvalue
                            ...
                            if (b.rail.drag) return b.rail.drag = false, b.cancelEvent(c)
                        },
                        b.onmousemove = function(c) {
                            if (b.rail.drag) {
                                b.scroll.y = b.rail.drag.sy + (c.screenY - b.rail.drag.y);
                    ...
                    b.onkeypress = function(c) {
                        ...
                        if (b.hasfocus || b.hasmousefocus && !l || b.ispage && !l && !o) {
                            d = c.keyCode;
                ...
                if (this.doc[0].nodeName == "IFRAME") {
                    var e = function() {
                        ...
                        }, b.docscroll = f(this.contentWindow);
                        ...
                        if (b.cantouch || b.opt.touchbehavior) b.bind(c, "mousedown",
                            b.onmousedown), b.cursorgrabvalue && b.css(f(c.body), {
                            cursor: b.cursorgrabvalue
                        });
            ...
            this.getContentSize = function() {
                return b.ispage ? {
                    ...
                    h: Math.max(b.iframe.html.scrollHeight,
            ...
            this.resize = this.onResize = function(c, d) {
                if (!b.haswrapper && !b.ispage)
                    if (b.win.css("display") != "none") b.show();
                    else return b.visibility && b.hide(), false;
                var e = b.page.maxh,
                    f = b.page.maxw,
                    h = b.view.w;
                b.view = {
                    w: b.ispage ? b.win.width() : b.win.innerWidth(),
                    h: b.ispage ? b.win.height() : b.win.innerHeight()
                };
                b.page = d ? d : b.getContentSize();
                b.page.maxh = Math.max(0, b.page.h - b.view.h);
                b.page.maxw = Math.max(0, b.page.w - b.view.w);
                if (b.page.maxh ==
                    e && b.page.maxw == f && b.view.w == h)
                ...
                if (b.page.maxh == 0) return b.hide(), b.scrollvaluemax = 0, b.scroll.y = 0, b.scrollratio = {
                    x: 0,
                    y: 0
                }, b.cursorheight = 0, b.locked = true, b.setScrollTop(0), false;
                else b.visibility || b.show();
                b.locked = false;
                b.istextarea && b.win.css("resize") && b.win.css("resize") != "none" && (b.view.h -= 20);
                b.ispage || b.updateScrollBar(b.view);
                b.cursorheight = Math.min(b.view.h,
            ...
            this._bind = function(c, d, e, f) {
                ...
                c.addEventListener ? c.addEventListener(d, e, f || false) : c.attachEvent ? c.attachEvent("on" + d, e) :
                    c["on" + d] = e
            };
            this.bind = function(c, d, e, f) {
                ...
                h.addEventListener ? (b.cantouch && /mouseup|mousedown|mousemove/.test(d) && b._bind(h, d == "mousedown" ? "touchstart" : d == "mouseup" ? "touchend" : "touchmove", function(b) {
                    ...
                    if ((c = c ||
                            window.event || false) && c.srcElement) c.target = c.srcElement;
            ...
            this.cancelEvent = function(c) {
                c = b.cantouch ? c.original ? c.original : c || false : c ? c : window.event || false;
                if (!c) return false;
                c.stopPropagation && c.stopPropagation();
                c.preventDefault && c.preventDefault();
                c.cancelBubble = true;
                c.cancel = true;
                return c.returnValue = false
            };
            this.show = function() {
                if (b.page.maxh != 0) b.visibility = true, b.rail.css("display", "block");
                return b
            };
            this.hide = function() {
                b.visibility = false;
            ...
            this.onmousewheel = function(c) {
                ...
                var d = 0;
                if (d = c.detail ? c.detail * -1 : c.wheelDelta / 40) b.scrollmom && b.scrollmom.y.stop(), b.doScrollBy(d * b.opt.mousescrollstep);
                return b.cancelEvent(c)
            };
            this.stop = function() {
                b.cancelScroll();
            ...
            b.ishwscroll && b.hastransition && b.opt.usetransition ? (this.prepareTransition =
                function(c) {
                    ...
                    b.setScrollTop(c);
                    b.noticeCursor(false, c);
                    c < 0 ? b.doScroll(0, 60) : c > b.page.maxh && b.doScroll(b.page.maxh,
                        60)
                }) : (this.doScroll = function(c) {
                function d() {
                    if (b.cancelAnimationFrame) return true;
                    if (h = 1 - h) return b.timer = m(d) || 1;
                    var c = b.getScrollTop(),
                        e = b.bzscroll ? b.bzscroll.getNow() : b.newscrolly,
                        c = e - c;
                    if (c < 0 && e < b.newscrolly || c > 0 && e > b.newscrolly) e = b.newscrolly;
                    b.setScrollTop(e);
                    e == b.newscrolly ? (b.timer = 0, b.cursorfreezed = false, b.bzscroll = false, e < 0 ? b.doScroll(0) : e > b.page.maxh && b.doScroll(b.page.maxh)) : b.timer = m(d) || 1
                }
                var e = b.getScrollTop();
                b.newscrolly = c;
                if (!b.bouncescroll)
                    if (b.newscrolly < 0) {
                        if (b.newspeedy) b.newspeedy.x =
                            0;
                        b.newscrolly = 0
            ...
            b.onscroll = function() {
                b.rail.drag ||
                    b.cursorfreezed || b.delayed("onscroll", function() {
                        b.scroll.y = Math.round(b.getScrollTop() * (1 / b.scrollratio.y));
                        b.noticeCursor()
                    }, 30)
            };
            ...
            this.doZoomIn = function(c) {
                if (!b.zoomactive) {
                    ...
                    for (h in d) {
                        var i = d[h];
                        b.zoomrestore.style[i] = typeof e[i] != "undefined" ? e[i] : ""
                    }
                    ...
                    if (b.isios4) b.zoomrestore.scrollTop = f(window).scrollTop(), f(window).scrollTop(0);
                    b.win.css({
            ...
            this.doZoomOut = function(c) {
                if (b.zoomactive) return b.zoomactive = false, b.win.css("margin", ""), b.win.css(b.zoomrestore.style), b.isios4 && f(window).scrollTop(b.zoomrestore.scrollTop), b.rail.css({
            ...
            this.resizeZoom = function() {
                if (b.zoomactive) {
                    var c = b.getScrollTop();
                    b.win.css({
                        width: f(window).width() - b.zoomrestore.padding.w + "px",
                        height: f(window).height() - b.zoomrestore.padding.h + "px"
                    });
                    b.onResize();
        ...
        w = function(e) {
            ...
            this.doSnapy = function(b) {
                b < 0 ? d.nc.doScroll(0, 60) : b > d.nc.page.maxh && d.nc.doScroll(d.nc.page.maxh, 60)
            };
            this.doMomentum = function() {
                var b = d.lasttime,
                    e = d.time();
                d.speedy = Math.min(60, d.speedy);
                if (d.speedy && b && e - b <= 50 && d.speedy) {
                    var f = e - b,
                        k = d.nc.page.maxh;
                    d.demuly = 0;
                    var l =
                        function() {
                            var b = Math.floor(d.nc.getScrollTop() - d.speedy * (1 - d.demuly));
                            d.demuly += b < 0 || b > k ? 0.08 : 0.01;
                            d.nc.setScrollTop(b);
                            d.nc.showCursor(b);
                            d.demuly < 1 ? d.timer = setTimeout(l, f) : (d.timer = 0, d.nc.hideCursor(), d.doSnapy(b))
                        };
                    l()
        ...
        k = f.fn.scrollTop;
    f.cssHooks.scrollTop = {
        get: function(e) {
            var d = f.data(e, "__nicescroll") || false;
            return d && d.ishwscroll ? d.getScrollTop() : k.call(e)
        },
        set: function(e, d) {
            var b = f.data(e, "__nicescroll") || false;
            b && b.ishwscroll ? b.setScrollTop(parseInt(d)) :
                k.call(e, d);
            return this
        }
    };
    f.fn.scrollTop = function(e) {
        if (typeof e == "undefined") {
            var d = this[0] ? f.data(this[0], "__nicescroll") || false : false;
            return d && d.ishwscroll ? d.getScrollTop() : k.call(this)
        } else return this.each(function() {
            var b = f.data(this, "__nicescroll") || false;
            b && b.ishwscroll ? b.setScrollTop(parseInt(e)) : k.call(f(this), e)
        })
    };
    var q = function(e) {
        var d = this;
        ...
        if (e)
            for (a = 0; a < e.length; a++) {
                var b = f.data(e[a], "__nicescroll") || false;
                b && (this[this.length] = b, this.length++)
            }
        return this
    };
    (function(e, d, b) {
        for (var f = 0; f < d.length; f++) b(e, d[f])
    })(q.prototype, "show,hide,onResize,resize,remove,stop".split(","), function(e, d) {
        e[d] = function() {
    ...
    f.fn.getNiceScroll = function(e) {
        return typeof e == "undefined" ? new q(this) : f.data(this[e], "__nicescroll") || false
    };
    f.extend(f.expr[":"], {
        nicescroll: function(e) {
            return f.data(e,
                "__nicescroll") ? true : false
        }
    });
    f.fn.niceScroll = function(e, d) {
        typeof d == "undefined" && typeof e == "object" && !("jquery" in e) && (d = e, e = false);
        var b = new q;
        typeof d == "undefined" && (d = {});
        if (e) d.doc = f(e), d.win = f(this);
        var h = !("doc" in d);
        if (!h && !("win" in d)) d.win = f(this);
        this.each(function() {
            var e = f(this).data("__nicescroll") || false;
            if (!e) d.doc = h ? f(this) : d.doc, e = new x(d, f(this)), f(this).data("__nicescroll", e);
            b.push(e)
        });
